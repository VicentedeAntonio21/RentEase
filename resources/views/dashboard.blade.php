<x-app-layout>
    ...
    <div class="space-y-6">
        ...
        <div
            class="bg-gradient-to-r from-primary to-primary-dark rounded-xl p-6 text-white flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
        ...
        @if (auth()->user()->isOwner())
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <a href="{{ route('owner.applications.received') }}"
                    class="bg-white dark:bg-[#252B3E] rounded-xl shadow-sm border border-gray-100 dark:border-white/5 p-5 flex items-center gap-4 hover:shadow-md transition-shadow animate-fade-in-up animate-delay-1">
                    <div class="w-12 h-12 rounded-full bg-warning/10 text-warning flex items-center justify-center">
                ...
                <a href="{{ route('owner.reports') }}"
                    class="bg-white dark:bg-[#252B3E] rounded-xl shadow-sm border border-gray-100 dark:border-white/5 p-5 flex items-center gap-4 hover:shadow-md transition-shadow animate-fade-in-up animate-delay-2">
