<x-app-layout>
    ...
    @if (session('error'))
        <div class="mb-4 p-3 bg-danger/10 text-danger rounded-lg text-sm flex items-center gap-2">
    ...
    <div class="max-w-2xl mx-auto space-y-6">
        ...
        <div
            ...
            <form action="{{ route('applications.store', $unit) }}" method="POST" class="p-6 space-y-5">
                ...
                <x-form-input name="move_in_date" label="Preferred Move-in Date" type="date" icon="ri-calendar-line"
                    required />
